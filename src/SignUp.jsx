  ...
  return (
   <div className='bg-gray-100 h-screen flex justify-center items-center'>
        <div className=' w-80 flex-col flex p-10 bg-white shadow border-0'>
           ...
           <input className='shadow px-4 py-1 mb-4' type='text' placeholder='enter Name '></input>
           ...
           <button className='bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 cursor-pointer'>Sign Up</button>
        </div>
