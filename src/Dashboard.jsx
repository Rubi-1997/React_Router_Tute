...
const Dashboard = () => {
  return (
    <div className="grid grid-cols-3 gap-4 w-full px-2">
      ...
      <div className=" grid grid-cols-1 gap-8 h-3/4">
        ...
        <div className="  shadow-2xl px-4 py-2">
          ...
          <div className="flex flex-wrap ">
            <p className="text-white text-sm px-2 py-1 mx-2 my-2 bg-black">
              Travel
            </p>
            <p className="text-white  text-sm px-4 py-2 mx-2 my-2 bg-black">
              London
            </p>
            <p className="text-white text-sm px-4 py-2 mx-2 my-2 bg-black">
              NewYork
      ...
      <div className=" col-span-2 ">
        <div class="w-full rounded overflow-hidden shadow-2xl h-3/4">
          <img
